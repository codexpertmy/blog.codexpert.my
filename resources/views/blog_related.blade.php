    ...
    <!-- Example row of columns -->
      <div class="row">
        <div class="col-md-10">
            ...
            <p class="alert alert-info">{{ $posts->count() }} found.</p>
            ...
            <p><span class="label label-primary">{{ $post->category->name ?? null }}</span></p>
       ...
       @empty
          <h4>I still looking for suitable time to create articles with related categories. or subscribe for any new posts published later? <a href="">Subscribe here.</a> Or just continue reading                       <a href="{{ url('/') }}">Back to Home</a>
</h4>
       @endforelse
        </div>
